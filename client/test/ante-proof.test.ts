...
// The same bytes are pinned in ante-core/src/proof.rs. A mismatch here means
// the TS and Rust halves have drifted; regenerate both from the example after
// a deliberate wire-format change (which is breaking for every stored proof).
const VECTOR = {
